...
- [ ] Four value-pillar posts drafted fresh, not lifted from the internal deck. The only unblocked item, so it goes first.
...
**Content for each client's customized build.** A real gap, confirmed independently by two people, and outside what I can fix in seven weeks. Naming it is this quarter's contribution; solving it isn't.
